...
const API_CODE_TO_TRPC: Record<ApiErrorCode, TrpcErrorCode> = {
  ...
  [API_ERROR_CODES.FORM_PASSWORD_REQUIRED]: "UNAUTHORIZED",
  [API_ERROR_CODES.FORM_PASSWORD_INVALID]: "UNAUTHORIZED",
  [API_ERROR_CODES.FORM_EXPIRED]: "PRECONDITION_FAILED",
  [API_ERROR_CODES.FORM_RESPONSE_LIMIT_REACHED]: "PRECONDITION_FAILED",
  [API_ERROR_CODES.FORM_ARCHIVED]: "NOT_FOUND",
  ...
  [API_ERROR_CODES.AUTH_EMAIL_NOT_VERIFIED]: "FORBIDDEN",
  [API_ERROR_CODES.AUTH_OTP_INVALID]: "BAD_REQUEST",
